...
if ! test -e .cdu; then
sha256sum -c uchimedb-0.9.YYYY.MM.DD.tar.xz.sha256 || exit $?
tar -xJf uchimedb-0.9.YYYY.MM.DD.tar.xz || exit $?
...
sha256sum -c taxdb-0.9.YYYY.MM.DD.tar.xz.sha256 || exit $?
tar -xJf taxdb-0.9.YYYY.MM.DD.tar.xz || exit $?
