...
if ! test -e .cdu; then
sha256sum -c uchimedb-v0.1.YYYY.MM.DD.tar.xz.sha256 || exit $?
tar -xJf uchimedb-v0.1.YYYY.MM.DD.tar.xz || exit $?
...
sha256sum -c taxdb-v0.1.YYYY.MM.DD.tar.xz.sha256 || exit $?
tar -xJf taxdb-v0.1.YYYY.MM.DD.tar.xz || exit $?
...
sha256sum -c blastdb-v0.1.YYYY.MM.DD.tar.xz.sha256 || exit $?
ls blastdb-v0.1.YYYY.MM.DD.tar.xz *.blastdb-v0.1.YYYY.MM.DD.tar.xz | xargs -P 4 -I {} sh -c 'tar -xJf {} || exit $?' || exit $?
