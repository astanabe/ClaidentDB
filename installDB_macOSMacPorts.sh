...
gnutar -xJf uchimedb-v0.1.YYYY.MM.DD.tar.xz || exit $?
...
gnutar -xJf taxdb-v0.1.YYYY.MM.DD.tar.xz || exit $?
...
ls blastdb-v0.1.YYYY.MM.DD.tar.xz *.blastdb-v0.1.YYYY.MM.DD.tar.xz | xargs -P 4 -I {} sh -c 'gnutar -xJf {} || exit $?' || exit $?
