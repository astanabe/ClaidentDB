...
clblastseq blastn -db `pwd`/blastdb/animals_genus -word_size 9 -evalue 1e-2 -strand plus -task blastn -max_target_seqs 10000000 end --output=ACCESSION --numthreads=$NCPU --hyperthreads=8 references_animals_16S.fasta animals_16S2.txt || exit $?
